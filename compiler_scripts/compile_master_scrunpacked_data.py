...
input_dir = base_dir / 'external_data' / 'scrunpacked'
output_dir = base_dir / 'compiled_data'
output_dir.mkdir(parents=True, exist_ok=True)
output_file = output_dir / 'master_scrunpacked.json'
...
print(f"✅ SCR unpacked data compiled successfully to: {output_file}")
